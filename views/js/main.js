...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.classList.add("img-responsive","pizzas");
...
var resizePizzas = function(size) { 
  ...
  // Used in course quiz https://www.udacity.com/course/viewer#!/c-ud860-nd/l-4147498575/e-4154208580/m-4240308553
...
// runs animationReadyCheck on scroll
window.addEventListener('scroll', animationReadyCheck);

//created animationReadyCheck function to handle requestAnimationFrame that runs updatePositions()
...
function updatePositions() {
  ...
  //sets animating to false so animationReadyCheck() will initialize
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    //removed unused 'basicLeft' - replaced with adjusted .left property to position pizzas correctly
	elem.style.left = (i % cols/2) * s + 'px';
